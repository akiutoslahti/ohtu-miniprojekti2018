...
public class DefaultController {
    ...
    @Autowired
    private BookTipRepository bookRepository;
    ...
    public void init() {
        ...
        bookTip1.getTags().add("fantasy");
        
        bookRepository.save(bookTip1);
        ...
        bookTip2.getTags().add("fantasy");
        bookRepository.save(bookTip2);
        ...
        bookTip3.getTags().add("fantasy");
        bookRepository.save(bookTip3);
    }
